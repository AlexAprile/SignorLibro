...
public class ProductValidator{
    public static RequestValidator validateUpForm(HttpServletRequest req){
        ...
        validator.assertMatch("titolo",Pattern.compile("^.{3,50}$"),"il nome deve contenere tra i 3 e i 50 caratteri");
        ...
        validator.assertMatch("isbn",Pattern.compile("^(978|979)\\d{10}$"),"");
